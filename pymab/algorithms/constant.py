...
# Softmax subtype
SOFTMAX_SUBTYPE_BOLTZMANN = 'Boltzmann-Softmax'

# Thompson subtypes
THOMPSON_SUBTYPE_BERNOULLI = 'Bernoulli-Thompson'
...
# Defaul alpha and beta for Beta distribution in Thompson sampling
DEFAULT_INITIAL_ALPHA = 1
DEFAULT_INITIAL_BETA = 1

# Default tau value in Boltzmann softmax method
DEFAULT_TAU = 0.8
DEFAULT_EPSILON = 0.05

# Default number of times for sampling in Thompson sampling method
DEFAULT_NUMBER_OF_SAMPLING = 1000
